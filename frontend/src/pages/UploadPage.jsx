      ...
      <Card title="上传文件" style={{ marginBottom: 20 }}>
        ...
        >
          ...
          <p className="ant-upload-hint">
            自动识别文件内容：债权清单（表格多笔）→ 勾选尽调；判决书/裁定书/合同等材料（单份）→ 可继续多传，全部收齐后统一分析；<br />
            自动提取债务人、债权人、本金、利息、利息计算方式、是否胜诉、抵押物（含设备租赁）等信息回填报告
          </p>
        </Dragger>
